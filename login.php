...
<div class="logincontainer">
  <button class="signupbutton" onclick="document.getElementById('signup').style = 'display:block;';this.style = 'display:none;'">signup</button>
  <div id='signup'>
      ...
      <button class="loginsubmit" button="loginsubmit" onclick="
  ...
  <button class="loginbutton" onclick="document.getElementById('login').style = 'display:block;';this.style = 'display:none;'">login</button>
  <div id='login'>
